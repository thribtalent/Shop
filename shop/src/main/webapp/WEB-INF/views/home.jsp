		...
		<c:forEach items="${categories}" var="category">
			...
			<%-- <div class="col-lg-4 mb-4">
				<div class="card h-100">
					...
					<div class="card-body">
						<img src="${images}/cal.jpg" alt="Nature" class="responsive" width="250" height="250">
					</div>
					<div class="card-footer">
						<a href="#" class="btn btn-primary">Add Cart</a>
			...
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					<h4 class="card-header">Pillow's</h4>
					<div class="card-body">
						<img src="${images}/pilo.png" alt="Nature" class="responsive" width="300" height="250">
					</div>
					<div class="card-footer">
						<a href="#" class="btn btn-primary">Add Cart</a>
						<label  class="float-right">Rs.300</label>
